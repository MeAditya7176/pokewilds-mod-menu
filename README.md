...
- **1-Click Quick Cheats:**
  - `⭐ +99 Master Balls` (100% Catch Rate on any wild Pokémon)
  - `🍬 +99 Rare Candies` (Instant level up)
  - `💎 +20 All Evolution Stones` (Fire, Water, Thunder, Leaf, Moon, Sun, Dawn, Dusk, Shiny, Ice)
...
> - Your new Pokémon, Master Balls, and Shiny stats will immediately appear!

---

## 🛠️ Building from Source

This tool is written in standalone C# and requires **no external dependencies or Visual Studio installation** to build!
...
- This is a free, fan-made open-source tool created for educational purposes and offline single-player enjoyment of [PokéWilds](https://github.com/SheerSt/pokewilds).
- Pokémon and all related trademarks are property of Nintendo, Game Freak, and The Pokémon Company.
- PokéWilds is developed by SheerSt and the PokéWilds community.
